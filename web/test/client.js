...
/***/ function(module, exports, __webpack_require__) {
	...
	var WSClient, generate, testcases;

	WSClient = __webpack_require__(1);

	if (window === parent) {
	  generate = __webpack_require__(50);
	  testcases = __webpack_require__(63);
	  generate(testcases);
	  __webpack_require__(64);
	  riot.mount("pre-info");
	} else if (location.hash.match("am-autoevent")) {
	  __webpack_require__(65);
	} else if (location.hash.match("am-coffee-time")) {
	  __webpack_require__(68);
	} else if (location.hash.match("am-simple-server")) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.riot = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	this.WholeStatus = WholeStatus = __webpack_require__(57);
	...
	WholeStatus = this.WholeStatus = __webpack_require__(57);
...
/***/ function(module, exports, __webpack_require__) {
	...
	this.isIos = __webpack_require__(56).ios();
	  ...
	  return function(callbackObj) {
	    ...
	    if (_this.isElectron) {
	      ...
	      return iframeWindow.addEventListener("load", function() {
	        ...
	        Test.prototype.params = __webpack_require__(2).prototype.getParams(iframeWindow.location.href);
...
/***/ function(module, exports, __webpack_require__) {
	...
	jquery_stylesheet = __webpack_require__(60);
	...
	module.exports = Test = (function() {
	  ...
	  Test._auto = function() {
	    return {
	      AutoEvent: __webpack_require__(61)
	    };
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	AutoEventBase = __webpack_require__(62);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"allpattern": {
			...
			"am-coffee-time": {
				"login": "/modules/am-coffee-time/web/index.html",
				"params1": "./index.html",
				"_color": "./index.html",
...
/***/ function(module, exports) {
	...
	riot.tag2('pre-info', '<a href="/?_noWs">/?_noWs(no websocket)</a> <a href="/?">/?(websocket)</a>', 'pre-info,[riot-tag="pre-info"],[data-is="pre-info"]{display:block;margin:10px 0} pre-info a,[riot-tag="pre-info"] a,[data-is="pre-info"] a{display:block}', '', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, AutoEvent, AutoEventNoGen, SampleTest, Test, func,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	AutoEventNoGen = __webpack_require__(61);

	Test = __webpack_require__(58);

	$("body").append($(__webpack_require__(66)));
	...
	SampleTest = (function(superClass) {
	  extend(SampleTest, superClass);

	  function SampleTest() {
	    return SampleTest.__super__.constructor.apply(this, arguments);
	  }

	  SampleTest.test = function() {
	    return func(AutoEvent);
	  };

	  SampleTest.testNoGen = function() {
	    return func(AutoEventNoGen);
	  };

	  SampleTest.global = function() {
	    __webpack_require__(67);
	    console.assert(window.amAutoEvent);
	    return console.info("finished");
	  };

	  SampleTest.timeout = function(ms) {
	    ...
	    return setTimeout(createTimeoutBox, 3000);
	  };

	  SampleTest.clickAssert = function(assertFlg) {
	    var ae;
	    ae = new AutoEvent;
	    return ae.register().wait(300).click(".box", assertFlg === "true").start();
	  };

	  SampleTest.select = function(value) {
	    var ae;
	    ae = new AutoEvent;
	    return ae.register().wait(300).selectValue("select", value).start();
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	$("body").append($(__webpack_require__(69)));
	...
	SampleTest = (function(superClass) {
	  ...
	  SampleTest.params1 = function(params1Val) {
	  ...
	  SampleTest._color = function(selector) {
	    SampleTest.__super__.constructor._color.call(this, selector);
	    selector = selector === true ? "*" : selector;
	  ...
	  SampleTest._border = function(selector) {
	    SampleTest.__super__.constructor._border.call(this, selector);
	    selector = selector === true ? "*" : selector;
	    return $(selector).each(function() {
	      var $this, tagName;
	      $this = $(this);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"p1\">\r\n  parent\r\n  <div class=\"child c-1\">\r\n    child 1\r\n    <div class=\"grandchild\">\r\n      grandchild\r\n    </div>\r\n  </div>\r\n  <div class=\"child c-2\">\r\n    child 2\r\n  </div>\r\n</div>\r\n<div style=\"width: 100px;display: inline-block; background: #ccc; margin: 40px;\">\r\n  <div style=\"width: 50px; display: inline-block;\">test1</div><div style=\"width: 50px; display: inline-block;\">test2</div>\r\n</div>\r\n<div style=\"height: 1000px; background: lightyellow\">\r\n  scroll area\r\n</div>\r\n<div style=\"background: lightblue; vertical-align: bottom\">\r\n  end line\r\n</div>\r\n<script type=\"text/javascript\">\r\n  let grandChild = document.querySelector(\".grandchild\")\r\n  setTimeout(() => grandChild.innerHTML += \"<div class='nest-grandchild'>nest grand child</div>\", 1000)\r\n</script>\r\n";

/***/ },
/* 70 */
/***/ function(module, exports, __webpack_require__) {

	var NewTest, Test, WSClient,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	NewTest = (function(superClass) {
	  ...
	  NewTest.port = function(number) {
	    var connectFlag, timeout, wsc;
	    wsc = new WSClient;
	    connectFlag = false;
	    wsc.start(number);
	    wsc.ws.off("connect");
	    wsc.ws.on("connect", function() {
	      connectFlag = true;
	      return console.info("finished");
	    });
	    timeout = function() {
	      if (!connectFlag) {
	        return console.assert(false, "websocket timeout");
	      }
	    };
	    return setTimeout(timeout, 1500);
	  };
