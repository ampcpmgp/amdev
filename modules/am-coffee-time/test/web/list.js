...
/***/ function(module, exports, __webpack_require__) {
	...
	Status = this.Status = __webpack_require__(11);
	...
	this.Status = __webpack_require__(11).on("item-update", (function(_this) {
	  return function() {
	    return _this.update();
	  };
	})(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	testcases = __webpack_require__(25);

	generate(testcases, {
	  prefix: ["日本語(lang=ja)", "英語(lang=en)", "lang=zh-cn", "lang=zh-tw"]
	});
...
/***/ function(module, exports) {
	...
	module.exports = {
		"am-coffee-time": {
			"int=1": "./index.html",
			"bool=false": "./index.html",
			"types=555,true": "./index.html",
			"typecheck=\"111\",3": "./index.html",
			"nullcheck=null/undefinedCheck=undefined": "./index.html",
			"params1": "./index.html",
			"_color": "./index.html",
			...
			"タスクリスト一覧": "./index.html",
			"多言語切り替え[新言語(lang=new) | 旧言語(lang=old)]": "./index.html",
