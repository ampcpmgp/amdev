...
# atom package
apm install pigments highlight-selected highlight-column save-session tabs-to-spaces editorconfig linter linter-coffeelint script pretty-json atom-terminal
## styesheet
atom-text-editor {
